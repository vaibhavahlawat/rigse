...
describe SessionsController do
  ...
  describe "logout_killing_session!" do
    ...
    it 'nils the current user'      do logout_killing_session!; current_user_or_guest.should be_nil end
    ...
    it 'forgets me' do    
      current_user_or_guest.remember_me
      current_user_or_guest.remember_token.should_not be_nil; current_user_or_guest.remember_token_expires_at.should_not be_nil
  ...
  describe "logout_keeping_session!" do
    ...
    it 'nils the current user'      do logout_keeping_session!; current_user_or_guest.should be_nil end
    it 'kills :user_id session' do
      session.stub!(:[]=)
      session.should_receive(:[]=).with(:user_id, nil).at_least(:once)
